...
def _get_broadcast_sub_area_back_link(service_id, broadcast_message_id, library_slug, area):
...
def choose_broadcast_sub_area(service_id, broadcast_message_id, library_slug, area_slug):
    ...
    back_link = _get_broadcast_sub_area_back_link(service_id, broadcast_message_id, library_slug, area)
