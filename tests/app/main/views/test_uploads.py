...
def test_post_choose_upload_file_redirects_for_valid_file(client_request):
...
def test_post_choose_upload_file_shows_error_when_file_is_not_a_pdf(client_request):
